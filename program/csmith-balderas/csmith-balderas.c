...
static const int32_t g_7[3][2][2] = {{{1L,1L},{1L,1L}},{{1L,1L},{1L,1L}},{{1L,1L},{1L,1L}}};
static const int32_t *g_6 = &g_7[0][1][1];
static union U0 g_8 = {65535UL};
...
{ /* block id: 0 */
    ...
    for (g_2 = 23; (g_2 == (-12)); g_2 = safe_sub_func_int64_t_s_s(g_2, 7))
    { /* block id: 3 */
        g_6 = l_5;
    }
    return g_8;
