...
{ /* block id: 0 */
    ...
    if (l_2)
    { /* block id: 1 */
        int8_t l_5[10][3] = {{7L,0x56L,7L},{7L,0L,(-4L)},{7L,6L,0xCCL},{7L,0x56L,7L},{7L,0L,(-4L)},{7L,6L,0xCCL},{7L,0x56L,7L},{7L,0L,(-4L)},{7L,6L,0xCCL},{7L,0x56L,7L}};
        int32_t *l_6 = &g_4;
        int i, j;
        g_3 = g_3;
        (*l_6) |= l_5[0][2];
