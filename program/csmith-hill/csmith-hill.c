...
/* --- GLOBAL VARIABLES --- */
static volatile uint16_t g_9 = 65531UL;/* VOLATILE GLOBAL g_9 */
static struct S0 g_12 = {-1L,1L,1L,2UL,0xAB89BDD7L,6L,0UL};/* VOLATILE GLOBAL g_12 */
...
{ /* block id: 0 */
    ...
    int32_t *l_6 = &l_4[2];
    int32_t *l_7 = &l_4[1];
    int32_t *l_8[2][8] = {{&l_4[0],&l_4[2],(void*)0,(void*)0,&l_4[2],&l_4[0],&l_4[2],(void*)0},{&l_4[1],&l_4[2],&l_4[1],&l_4[0],&l_4[0],&l_4[1],&l_4[2],&l_4[1]}};
    int i, j;
    for (i = 0; i < 3; i++)
        l_4[i] = 0x0A7084BCL;
    ++g_9;
