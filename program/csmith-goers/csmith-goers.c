...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0x2FAFD11DL;
static volatile uint16_t g_6 = 0x15E3L;/* VOLATILE GLOBAL g_6 */
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t *l_4[3];
    int32_t l_5[8] = {0x31E19E95L,(-1L),0x31E19E95L,0x31E19E95L,(-1L),0x31E19E95L,0x31E19E95L,(-1L)};
    int i;
    for (i = 0; i < 3; i++)
        l_4[i] = &g_3;
    g_6++;
